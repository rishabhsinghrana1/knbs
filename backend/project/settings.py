...
SECRET_KEY = 'django-insecure-=4(%8er)o%9fl!ie+hf@w&8!)14(fs*e_h(dy%v0(%b(@9ceb-'
...
#         'ENGINE': 'mssql',
#         'NAME': 'knbs_system',
#         'HOST': r'DESKTOP-OE7LATU\SQLEXPRESS',
#         'OPTIONS': {
...
DATABASES = {
    'default': {
        'ENGINE': 'mssql',
        'NAME': 'knbs_system_new',
        'HOST': 'DESKTOP-OE7LATU\\SQLEXPRESS',
        'PORT': '',
        'USER': '',
        'PASSWORD': '',
        'OPTIONS': {
